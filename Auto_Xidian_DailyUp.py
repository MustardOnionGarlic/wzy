...
def send_email(message):  # 发送一封邮件
    msg_from = '1846448761@qq.com'  # ￥ 发送方邮箱 
    passwd = 'nsrxrfnjpkyeecgf'  # ￥ 发送方邮箱密码，QQ邮箱，新浪邮箱请填写授权码
...
result_login = conn.post(
    ...
    data={'username': '20009200961', 'password': 'wzy13477491171'}#￥ username后填写学号，password后填写统一登录密码
)
